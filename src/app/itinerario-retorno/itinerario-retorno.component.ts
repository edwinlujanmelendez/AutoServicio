...
export class ItinerarioRetornoComponent implements OnInit {
    ...
    if(isPlatformBrowser(this.platformId)){
      setTimeout(() => {
        ...
        if(JSON.stringify(getDatosAsientos)!="{}"){
          ...
          this.StorageDatosAsientos = getDatosAsientos;

          /*var newListaVueltaDisponibles = [{}];
          var nombre_filtro = "";
          if(getDatosAsientos['nombre_ciudad_origen'] == "LIMA - TOMAS VALLE"){
            nombre_filtro = "Nicolas Arriola";
          }else if(getDatosAsientos['nombre_ciudad_origen'] == "LIMA - NICOLAS ARRIOLA"){
            nombre_filtro = "Tomas Valle";
          }

          for(var a=0; a<getDatosAsientos['listaVueltaDisponibles'].length; a++){
            var direccionDesembarque = String(getDatosAsientos['listaVueltaDisponibles'][a]['direccionDesembarque']);
            direccionDesembarque.replace("á", "a");
            direccionDesembarque.replace("é", "e");
            direccionDesembarque.replace("í", "i");
            direccionDesembarque.replace("ó", "o");
            direccionDesembarque.replace("ú", "u");

            if(!direccionDesembarque.includes(nombre_filtro)){
              newListaVueltaDisponibles.push(getDatosAsientos['listaVueltaDisponibles'][a]);
            }
          }

          newListaVueltaDisponibles.shift();*/

          this.datos = getDatosAsientos['listaVueltaDisponibles'];
  ...
  siguiente(){
    if(this.itinerario_seleccionado == ""){
      ...
      var dat = {
        "nombre_ciudad_origen": this.StorageDatosAsientos['nombre_ciudad_origen'],
        "nombre_ciudad_destino": this.StorageDatosAsientos['nombre_ciudad_destino'],
        "fechaEmbarqueIda": this.StorageDatosAsientos['fechaEmbarqueIda'],
        "fechaDesembarqueIda": this.StorageDatosAsientos['fechaDesembarqueIda'],
        "horaEmbarqueIda": this.StorageDatosAsientos['horaEmbarqueIda'],
        "horaDesembarqueIda": this.StorageDatosAsientos['horaDesembarqueIda'],
        "agenciaEmbarqueIda": this.StorageDatosAsientos['agenciaEmbarqueIda'],
        "agenciaDesembarqueIda": this.StorageDatosAsientos['agenciaDesembarqueIda'],
        "direccionEmbarqueIda": this.StorageDatosAsientos['direccionEmbarqueIda'],
        "direccionDesembarqueIda": this.StorageDatosAsientos['direccionDesembarqueIda'],
        "idAgenciaEmbarqueIda": this.StorageDatosAsientos['idAgenciaEmbarqueIda'],
        "idAgenciaDesembarqueIda": this.StorageDatosAsientos['idAgenciaDesembarqueIda'],
        "idServicioIda": this.StorageDatosAsientos['idServicioIda'],
        "servicioIda": this.StorageDatosAsientos['servicioIda'],
        "idItinerarioIda": this.StorageDatosAsientos['idItinerarioIda'],
        "idRutaIda": this.StorageDatosAsientos['idRutaIda'],
        "fechaEmbarqueVuelta": this.itinerario_seleccionado['fechaEmbarque'],
        "fechaDesembarqueVuelta": this.itinerario_seleccionado['fechaDesembarque'],
        "horaEmbarqueVuelta": this.itinerario_seleccionado['horaEmbarque'],
        "horaDesembarqueVuelta": this.itinerario_seleccionado['horaDesembarque'],
        "agenciaEmbarqueVuelta": this.itinerario_seleccionado['ageEmbarque'],
        "agenciaDesembarqueVuelta": this.itinerario_seleccionado['ageDesembarque'],
        "direccionEmbarqueVuelta": this.itinerario_seleccionado['direccionEmbarque'],
        "direccionDesembarqueVuelta": this.itinerario_seleccionado['direccionDesembarque'],
        "idAgenciaEmbarqueVuelta": this.itinerario_seleccionado['idAgeEmbarque'],
        "idAgenciaDesembarqueVuelta": this.itinerario_seleccionado['idAgeDesembarque'],
        "idServicioVuelta": this.itinerario_seleccionado['idServicio'],
        "servicioVuelta": this.itinerario_seleccionado['servicio'],
        "idItinerarioVuelta": this.itinerario_seleccionado['iditinerario'],
        "idRutaVuelta": this.itinerario_seleccionado['idruta'],
        "numAsientosIda": this.StorageDatosAsientos['numAsientosIda'],
        "numAsientosIdaP1": this.StorageDatosAsientos['numAsientosIdaP1'],
        "numAsientosIdaP2": this.StorageDatosAsientos['numAsientosIdaP2'],
        "estructuraBusIda": this.StorageDatosAsientos['estructuraBusIda'],
        "numAsientosVuelta": "",
        "numAsientosVueltaP1": "",
        "numAsientosVueltaP2": "",
        "estructuraBusVuelta": [],
        "listaIdaDisponibles": this.StorageDatosAsientos['listaIdaDisponibles'],
        "listaVueltaDisponibles": this.StorageDatosAsientos['listaVueltaDisponibles'],
        "ida_vuelta": this.StorageDatosAsientos['ida_vuelta'],
        "precioAsientosIda": this.StorageDatosAsientos['precioAsientosIda'],
      ...
      this.ir_seleccionar_asientos_vuelta();
    }
  }
  ...
  ir_seleccionar_asientos_vuelta(){
